/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a0d5e580fd077882f1d3567f82253fa2)
...
declare namespace Cloudflare {
	interface Env {
		...
		CLOUDFLARE_ACCESS_APPLICATION_AUD: string;
		NEXT_PUBLIC_CLOUDFLARE_ACCESS_TEAM_NAME: string;
		NEXT_PUBLIC_TURNSTILE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		RESEND_API_KEY: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* portfolio-dev */;
		ASSETS: Fetcher;
	}
}
